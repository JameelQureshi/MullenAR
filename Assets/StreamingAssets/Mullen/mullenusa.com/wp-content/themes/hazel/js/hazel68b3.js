...
/* BK */
jQuery(function(){
	//jQuery('.linearicons-pencil-ruler').replaceWith('<img src="/wp-content/uploads/2019/01/carhub-light.png">');
	//jQuery('.linearicons-gift').replaceWith('<img src="/wp-content/uploads/2019/01/mullen_auto_sales_light.png">');
	//jQuery('.linearicons-laptop-phone').replaceWith('<img src="/wp-content/uploads/2019/01/ottava-light.png">');
	
	/*setTimeout(function(){
		jQuery('#mull-about-box .upb_row_bg').css('background-image','url(/wp-content/uploads/2019/01/about-bg.jpg)');		
	}, 2000);*/
	
	//jQuery('.logo_normal.notalone').attr('src','/wp-content/uploads/2019/01/mullen-logo-black.png');
	//jQuery('.logo_normal.logo_after_scroll.notalone').attr('src','/wp-content/uploads/2019/01/mullen-logo-white.png');
	//jQuery('.logo_retina').attr('src','/wp-content/uploads/2019/01/mullen-logo-black.png');
	//jQuery('.logo_retina.logo_after_scroll').attr('src','/wp-content/uploads/2019/01/mullen-logo-white.png');
});
