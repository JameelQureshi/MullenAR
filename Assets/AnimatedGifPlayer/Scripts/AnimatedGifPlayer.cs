...
namespace OldMoatGames {
    ...
    public class AnimatedGifPlayer : MonoBehaviour {
        ...
        private void SetTexture() {
            ...
            targetImage.sprite = Sprite.Create(GifTexture, new Rect(0.0f, 0.0f, GifTexture.width, GifTexture.height), new Vector2(0.5f, 0.5f), 100f, 0, SpriteMeshType.FullRect);
        }
...
#if UNITY_EDITOR
            if (AutoPlay && Application.isPlaying) Play();
            onStartPlaying.Invoke();
            //don't start autoplay in the editor
#else
            if (AutoPlay) Play();
            onStartPlaying.Invoke();
#endif
